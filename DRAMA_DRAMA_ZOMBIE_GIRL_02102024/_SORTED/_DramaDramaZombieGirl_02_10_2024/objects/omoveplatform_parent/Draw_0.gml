var _drawself = draw_sprite_ext(sprite_index,image_index,x,(y+z),image_xscale,image_yscale,0,c_white,1);
draw_sprite_ext(sprite_index,5,x,(y+z),image_xscale,image_yscale,0,c_white,1);
/*
switch(_dir) {

case 0: 

draw_sprite_ext(sprite_index,1,x,(y+z),image_xscale,image_yscale,0,c_white,1);


break;

case 1:
draw_sprite_ext(sprite_index,3,x,(y+z),image_xscale,image_yscale,0,c_white,1);
break;


case 2:
draw_sprite_ext(sprite_index,4,x,(y+z),image_xscale,image_yscale,0,c_white,1);
break;


case 3:
draw_sprite_ext(sprite_index,2,x,(y+z),image_xscale,image_yscale,0,c_white,1);
break;
